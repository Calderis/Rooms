...
// page de recherche d'une série en fonction de son id, si on ne l'a pas alors on redirige sur la page d'erreur
...
<html lang="en">
	...
	<!-- HEADER = déconnexion, boutons interactions -->
		...
		$ch = curl_init('http://eztvapi.re/show/'.$id_search); // Le 1 correspond à la page n°1 sur l'api
		...
		?>
       	...
       	<section class="listItems">
			<ul id="A" class="series">
				<?php
				$id = $objs['_id']; // id de la série
				$poster = $objs['images']['poster']; // image de la série
				?>
				<!-- Affichage de l'affiche/série -->
				<li name="<?= $id ?>" data-ulid="A" data-j="1" data-id="<?= $id ?>">
					<img src="<?= $poster ?>" alt="">
					<span class="hover">
	           			<div class="see"></div>
	       			</span>
			...
			<?= '<div id="descA" class="descBlock">' ?>
			<!-- <div id="desc"> -->
	          	<div class="cross" onclick="closeIt('A')"></div>
	               	<div class="center">
	                   	<div class="hist">
	                       	<h1 class="title"></h1>
	                            ...
	                            <div class="fen">
                                  	<div class="padding">
	                                   	...
	                                   	<form action="#" method="post">
	                                       	...
	                                       	min
	                                       	<br />
	                                     	<input type="number" name="num_sais"value="" placeholder="Numéro de saison" id="num_saisA">
	                                     	<input type="number" name="num_epi" value="" placeholder="Episode" id="num_epiA">
	                                     	<input type="text" name="id_serie" value="" placeholder="ID de la série (sous le nom)" id="id_serieA">
	                                       	<input type="submit" name="submit" id="submit" value="It's done !">
	                                   	</form>
	                               	</div>
	                            </div>
	                       	</div>
	                       	<ul class="listEpi open" id="listEpiA"></ul>
	                   	</div>
	               	</div>
	       		</div>
			</section>
		...
		<!-- morceau de script pour Facebook Connect -->
	    <script>
